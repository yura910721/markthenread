...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "MarTheReaDB";
 
    // Contacts table name
    private static final String TABLE_CONTACTS = "Articles";
 
    // Contacts Table Columns names
    private static final String KEY_ID = "id";
    private static final String KEY_NAME = "title";
    private static final String KEY_PH_NO = "content";
    ...
    Contact getContact(String title) {
        ...
        /*Cursor cursor = db.query(TABLE_CONTACTS, new String[] { KEY_PH_NO }, KEY_ID + "=?",
                new String[] { String.valueOf(title) }, null, null, null, null);*/
        Cursor cursor = db.rawQuery("SELECT content FROM Articles WHERE title = '"+title+"'", null);
        if (cursor != null)
            cursor.moveToFirst();
